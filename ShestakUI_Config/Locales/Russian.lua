...
L.combattext_dodge_parry_miss = "Отображать сообщения о промахах, уклонениях и парированиях"
L.combattext_low_health_mana = "Предупреждать о низком уровне здоровья и маны"
